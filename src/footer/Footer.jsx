...
function InstagramIcon() {
  return (
    <svg className="h-4 w-4 shrink-0 text-blue-400" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="page-container pb-24 pt-14 sm:pb-8 lg:pt-20">
        <div className="grid grid-cols-1 items-start gap-x-10 gap-y-10 sm:grid-cols-2 lg:grid-cols-12">
          <div className="sm:col-span-2 lg:col-span-5">
            <a href="#inicio" aria-label="TresaSoft, volver al inicio" className="inline-block rounded-lg focus-visible:outline-blue-400">
          ...
          <nav aria-label="Navegación del pie de página" className="lg:col-span-3">
            ...
            <ul className="space-y-0.5 text-sm">
              {navigation.map((item) => (
                <li key={item.href}>
                  <a href={item.href} className="inline-flex min-h-10 items-center rounded transition-colors hover:text-white focus-visible:outline-blue-400">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div className="min-w-0 lg:col-span-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:TresArroyosSoft@gmail.com" className="inline-flex min-h-10 max-w-full items-center gap-3 rounded transition-colors hover:text-white focus-visible:outline-blue-400">
                  <Mail className="h-4 w-4 shrink-0 text-blue-400" aria-hidden="true" />
                  <span className="break-all">TresArroyosSoft@gmail.com</span>
                </a>
              </li>
              <li>
                <a href="https://instagram.com/tresasoft" target="_blank" rel="noopener noreferrer" className="inline-flex min-h-10 items-center gap-3 rounded transition-colors hover:text-white focus-visible:outline-blue-400">
                  <InstagramIcon />
                  <span>@tresasoft</span>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-slate-800 pt-6 text-xs text-slate-400 sm:flex-row sm:items-center sm:pr-20 lg:mt-16">
          ...
          <a href="#inicio" className="inline-flex min-h-11 items-center gap-2 rounded px-1 text-slate-300 transition-colors hover:text-white focus-visible:outline-blue-400">
